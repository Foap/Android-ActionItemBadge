...
public class ActionItemBadge {
    ...
    public enum BadgeStyles {
        GREY(new BadgeStyle(BadgeStyle.Style.DEFAULT, R.layout.menu_action_item_badge,
                Color.parseColor("#e0e0e0"), Color.parseColor("#c7c7c7"), Color.BLACK)),
        DARK_GREY(new BadgeStyle(BadgeStyle.Style.DEFAULT, R.layout.menu_action_item_badge,
                Color.parseColor("#606060"), Color.parseColor("#3e3e3e"), Color.WHITE)),
        RED(new BadgeStyle(BadgeStyle.Style.DEFAULT, R.layout.menu_action_item_badge,
                Color.parseColor("#FF4444"), Color.parseColor("#CC0000"), Color.WHITE)),
        BLUE(new BadgeStyle(BadgeStyle.Style.DEFAULT, R.layout.menu_action_item_badge,
                Color.parseColor("#33B5E5"), Color.parseColor("#0099CC"), Color.WHITE)),
        GREEN(new BadgeStyle(BadgeStyle.Style.DEFAULT, R.layout.menu_action_item_badge,
                Color.parseColor("#99CC00"), Color.parseColor("#669900"), Color.WHITE)),
        PURPLE(new BadgeStyle(BadgeStyle.Style.DEFAULT, R.layout.menu_action_item_badge,
                Color.parseColor("#AA66CC"), Color.parseColor("#9933CC"), Color.WHITE)),
        YELLOW(new BadgeStyle(BadgeStyle.Style.DEFAULT, R.layout.menu_action_item_badge,
                Color.parseColor("#FFBB33"), Color.parseColor("#FF8800"), Color.WHITE)),
        GREY_LARGE(new BadgeStyle(BadgeStyle.Style.LARGE, R.layout.menu_action_item_badge_large,
                Color.parseColor("#e0e0e0"), Color.parseColor("#c7c7c7"), Color.BLACK)),
        DARK_GREY_LARGE(
                new BadgeStyle(BadgeStyle.Style.LARGE, R.layout.menu_action_item_badge_large,
                        Color.parseColor("#606060"), Color.parseColor("#3e3e3e"), Color.WHITE)),
        ...
        GREEN_LARGE(new BadgeStyle(BadgeStyle.Style.LARGE, R.layout.menu_action_item_badge_large,
                Color.parseColor("#99CC00"), Color.parseColor("#669900"), Color.WHITE)),
        PURPLE_LARGE(new BadgeStyle(BadgeStyle.Style.LARGE, R.layout.menu_action_item_badge_large,
                Color.parseColor("#AA66CC"), Color.parseColor("#9933CC"), Color.WHITE)),
        YELLOW_LARGE(new BadgeStyle(BadgeStyle.Style.LARGE, R.layout.menu_action_item_badge_large,
                Color.parseColor("#FFBB33"), Color.parseColor("#FF8800"), Color.WHITE)),
        ;
    ...
    public static void update(final Activity act, final MenuItem menu, IIcon icon, int badgeCount) {
        if (badgeCount == Integer.MIN_VALUE) {
            update(act, menu,
                    new IconicsDrawable(act, icon).color(IconicsColor.colorInt(Color.WHITE))
                            .actionBar(), BadgeStyles.DARK_GREY.getStyle(), null);
        } else {
            update(act, menu,
                    new IconicsDrawable(act, icon).color(IconicsColor.colorInt(Color.WHITE))
                            .actionBar(), BadgeStyles.DARK_GREY.getStyle(),
                    String.valueOf(badgeCount));
        }
    }

    public static void update(final Activity act, final MenuItem menu, IIcon icon,
            String badgeCount) {
        update(act, menu, new IconicsDrawable(act, icon).color(IconicsColor.colorInt(Color.WHITE))
                .actionBar(), BadgeStyles.DARK_GREY.getStyle(), badgeCount);
    }

    public static void update(final Activity act, final MenuItem menu, IIcon icon,
            BadgeStyles style, int badgeCount) {
        update(act, menu, icon, style.getStyle(), badgeCount);
    }

    public static void update(final Activity act, final MenuItem menu, IIcon icon, BadgeStyle style,
            int badgeCount) {
        if (badgeCount == Integer.MIN_VALUE) {
            update(act, menu,
                    new IconicsDrawable(act, icon).color(IconicsColor.colorInt(Color.WHITE))
                            .actionBar(), style, null);
        } else {
            update(act, menu,
                    new IconicsDrawable(act, icon).color(IconicsColor.colorInt(Color.WHITE))
                            .actionBar(), style, String.valueOf(badgeCount));
        }
    }
    ...
    public static void update(final Activity act, final MenuItem menu, IIcon icon, BadgeStyle style,
            String badgeCount) {
        update(act, menu, new IconicsDrawable(act, icon).color(IconicsColor.colorInt(Color.WHITE))
                .actionBar(), style, badgeCount);
    }

    public static void update(final Activity act, final MenuItem menu, IIcon icon, int iconColor,
            int badgeCount) {
    ...
    public static void update(final Activity act, final MenuItem menu, IIcon icon, int iconColor,
            BadgeStyle style, int badgeCount) {
        if (badgeCount == Integer.MIN_VALUE) {
            update(act, menu, new IconicsDrawable(act, icon).color(IconicsColor.colorInt(iconColor))
                    .actionBar(), style, null);
        } else {
            update(act, menu, new IconicsDrawable(act, icon).color(IconicsColor.colorInt(iconColor))
                    .actionBar(), style, String.valueOf(badgeCount));
    ...
    public static void update(final Activity act, final MenuItem menu, IIcon icon, int iconColor,
            BadgeStyle style, String badgeCount) {
        update(act, menu,
                new IconicsDrawable(act, icon).color(IconicsColor.colorInt(iconColor)).actionBar(),
                style, badgeCount);
    }

    public static void update(final Activity act, final MenuItem menu, Drawable icon,
            BadgeStyles style, int badgeCount) {
        if (badgeCount == Integer.MIN_VALUE) {
    ...
    public static void update(final Activity act, final MenuItem menu, Drawable icon,
            BadgeStyles style, String badgeCount) {
        update(act, menu, icon, style.getStyle(), badgeCount);
    }
    ...
    public static void update(final Activity activity, final MenuItem menu, Drawable icon,
            BadgeStyle style, int badgeCount) {
        update(activity, menu, icon, style, badgeCount, null);
    }

    public static void update(final Activity activity, final MenuItem menu, Drawable icon,
            BadgeStyle style, int badgeCount, ActionItemBadgeListener listener) {
        if (badgeCount == Integer.MIN_VALUE) {
     ...
     */
    public static void update(final Activity activity, final MenuItem menu, Drawable icon,
            BadgeStyle style, String badgeCount, final ActionItemBadgeListener listener) {
        if (menu == null) {
            return;
        }
        ...
        if (activity != null) {
            ...
            badge.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    toast.setGravity(Gravity.TOP, width / 5,
                            UIUtil.convertDpToPx(activity, 48)); //your width and height
                    toast.show();
                    return true;
                }
            });
